const translations = {
  en: {
    ...
    "openSource.body": "Reusable foundations for motion research, scalable model training, open datasets, and agent-assisted research workflows.",
  ...
  zh: {
    ...
    "openSource.body": "面向动作研究、规模化模型训练、开放数据与 Agent 辅助科研工作流的可复用基础设施。",
